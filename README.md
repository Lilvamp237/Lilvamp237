...
I am versatile across different domains, utilizing a variety of programming languages, frameworks, and concepts:
...
* **E-Shuttle: University Transportation System:** Led the development of a full-stack mobile app (using Flutter) and an Admin web portal for real-time shuttle tracking, ticketing, and route management. (Mar–Nov 2024)
* **Audio Denoising System:** Developed a system using **Deep Learning (autoencoders)** to remove unwanted noise from audio signals, complete with a cross-platform **PyQt GUI**. (Sep–Oct 2024)
